...
#ifndef PROJECT_5900_SHADER_H
#define PROJECT_5900_SHADER_H
...
{	
	class CgShader
	{
		...
		public:
			...
			CgShader(CGcontext cgContext, CgShader::Type enType);
			virtual ~CgShader();
			
			
		public:
				
			void					SetProgram(const std::string& refProgram);
			void					SetProgram(CgShader::Type enType, const std::string& refProgram);
			
			void					SetEntry(const std::string& refEntry);
			void					SetEntry(CgShader::Type enType, const std::string& refEntry);
		...
		protected:
			...
			CGprofile				m_cgProfileVertex;
			CGprofile				m_cgProfileFragment;
			
			CGprogram				m_cgShaderVertex;
			CGprogram				m_cgShaderFragment;
			
			std::string				m_sProgramVertex;
			std::string				m_sProgramFragment;
			
			std::string				m_sEntryVertex;
			std::string				m_sEntryFragment;
			
			CgShader::Type			m_enType;
	};
}

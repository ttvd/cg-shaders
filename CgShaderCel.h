...
#ifndef PROJECT_5900_SHADERCEL_H
#define PROJECT_5900_SHADERCEL_H
...
{
	class CgShaderCel : public CgShader
	{
		public:
			
			CgShaderCel(CGcontext cgContext);
			~CgShaderCel();
		...
		public:
			...
			void					SetParamLightColor(const float* pVec);
			void					SetParamLightPosition(const float* pVec);
			
			void					SetParamEyePosition(const float* pVec);
			
			void					SetParamComputeOutline(bool bEnabled);
		...
		protected:
			...
			CGparameter				m_cgParamModelViewMatrix;
			CGparameter				m_cgParamModelViewITMatrix;
			
			CGparameter				m_cgParamLightColorVector;
			CGparameter				m_cgParamLightPositionVector;
			CGparameter				m_cgParamEyePositionVector;
			
			CGparameter				m_cgParamShininess;
			
			CGparameter				m_cgParamMatSpecularVector;
			CGparameter				m_cgParamMatDiffuseVector;
			
			
			GLuint					m_glIDTextureDiffuse;
			GLuint					m_glIDTextureSpecular;
			GLuint					m_glIDTextureOutline;
			
			CGparameter				m_cgParamSamplerDiffuse;
			CGparameter				m_cgParamSamplerSpecular;
			CGparameter				m_cgParamSamplerOutline;
			
			CGparameter				m_cgParamComputeOutline;

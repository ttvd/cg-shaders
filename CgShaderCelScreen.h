...
#ifndef PROJECT_5900_SHADERCELSCREEN_H
#define PROJECT_5900_SHADERCELSCREEN_H

#include "CgShader.h"

namespace Project5900
{
	class CgShaderCelScreen : public CgShader
	{
		public:
			
			CgShaderCelScreen(CGcontext cgContext);
		...
		public:
			...
			void					SetParamSamplerCel(GLuint glIDTexCel);
			void					SetParamSamplerOutline(GLuint glIDTexOutline);
		...
		protected:
			...
			CGparameter				m_cgParamSamplerCel;
